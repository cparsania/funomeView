...
golem::fill_desc(
  pkg_name = "funomeView", # The Name of the package containing the App 
  pkg_title = "Fungal genome visualization resource", # The Title of the package containing the App 
  pkg_description = "PKG_DESC.", # The Description of the package containing the App 
  author_first_name = "Chirag", # Your First Name
  author_last_name = "Parsania",  # Your Last Name
  author_email = "chirag.parsania@gmail.com",      # Your Email
